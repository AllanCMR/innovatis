...
def mostra_resultado(pontos):
    ...
    if pontos == 20:
        ...
        lblimagem.image = img
        lblresulttext.configure(text=f"Parabéns, você fez {pontos} pontos!\nDemonstrou grande conhecimento\nsobre o Covid-19!", fg='#008000', font=' Consolas 20 bold')

    elif 10 <= pontos <= 19:
        img = PhotoImage(file="ok.png")
        lblimagem.configure(image=img)
        lblimagem.image = img
        lblresulttext.configure(text=f"Você foi bem! Fez {pontos} pontos.\n Mas ainda pode melhorar!\nProcure se atualizar mais"
                                     "\na respeito do Covid-19\npara não ser infectado!", fg='#002699', font='Consolas 20 bold')
    else:
        ...
        lblresulttext.configure(text=f"Poxa, que pena! Você fez apenas {pontos} pontos.\nPrecisa se atualizar bastante\na respeito do Covid-19"
                                     "\npara não ser infectado!", fg='#cc0000', font='Consolas 20 bold')
